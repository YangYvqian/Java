...
(四) 解决继承及实现接口出现同名方法的问题(ResolveSameNameMethod)
...
// 此时就会发现，不清楚这个test方法是接口的还是类的。

}

public class ResolveSameNameMethod extends MyDemo{
    ...
    public static void main(String[] args) {
        ResolveSameNameMethod resolveSameNameMethod = new ResolveSameNameMethod();
        Demo d = resolveSameNameMethod.getInner();
        d.test();
        resolveSameNameMethod.test();
    }
