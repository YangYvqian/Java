...
(三) 用匿名内部类实现回调功能(AnonymousOuterInnerCallBack)
...
public class AnonymousOuterInnerCallBack {
    ...
    public static void main(String[] args) {
        AnonymousOuterInnerCallBack anonymousOuterInnerCallBack = new AnonymousOuterInnerCallBack();
        anonymousOuterInnerCallBack.test(new Demo() {
